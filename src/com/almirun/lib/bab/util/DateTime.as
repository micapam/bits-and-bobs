package com.almirun.lib.bab.util {
  
	import com.almirun.lib.bab.util.Strings;
	...
	public class DateTime {
		...
		private static var abbrDays:Array = ["Sun", "Mon", "Tue", "Wed", "Thur",
			"Fri", "Sat"];
	
		private static var fullDays:Array = ["Sunday", "Monday", "Tuesday",
		...
		private static function b (date:Date):String {
			return DateTime.abbrMonths[date.getMonth()];
		}
		
		private static function B (date:Date):String {
			return DateTime.fullMonths[date.getMonth()];
		}
		...
		private static function m (date:Date):String {
			return Strings.zerofill(date.getMonth() + 1, 2);
		}
				
		private static function M (date:Date):String {
			return Strings.zerofill(date.getMinutes(), 2);
		}
		...
		private static function y (date:Date):String {
			return Strings.zerofill(date.getFullYear() % 100, 2);
		}
